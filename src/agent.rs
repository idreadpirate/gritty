...
/// Rows of the live screen tail the detector inspects each poll. Enough to span
/// an agent's prompt box plus the working/blocked chrome above it, while staying
/// far cheaper than scanning the whole grid.
pub const DETECT_TAIL_ROWS: usize = 24;
